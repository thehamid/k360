                ...
                <div className="order-1 mb-3 flex items-center gap-1 lg:order-2 lg:mb-0">
                  ...
                  >
                    <a href="https://kelaket360.ir/media/zalem" id="show-title">
                      {mediaData.name} ({mediaData.episodes[0].title})
                    </a>
                  </h1>
          ...
          <div className="grid grid-cols-8 gap-8">
            ...
            <div className="col-span-8 space-y-6 lg:col-span-4 mt-5">
              ...
              <div className="expert">
                <div className="flex items-center justify-start">
                  <h2 className="pinline text-base font-normal capitalize dark:font-extrabold dark:text-white mb-2">داستان این قسمت</h2>
                </div>
                <div className="h-auto min-h-20 rounded-md p-2 w-full bg-zinc-800">
                {mediaData.episodes[0].expert }
                </div>
              </div>

              <div className="photos">
                <div className="flex items-center justify-start">
                  <h2 className="pinline text-base font-normal capitalize dark:font-extrabold dark:text-white mb-2">تصاویر</h2>
                </div>
                <div className="h-auto min-h-20 rounded-md p-2 w-full bg-zinc-800">
                {mediaData.episodes[0].photos }
                </div>
              </div>
            ...
            <div className="col-span-8 lg:col-span-2">
              <div className="sidebar">
                <div className="p-2">
                  <button className="border-gray-100 border-2  text-white rounded-lg  w-full text-center p-3 m-2">این قسمت را تماشا کرده ام</button>
                </div>
                <div className="p-2">
