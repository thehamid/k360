...
import ActorCard from '@/components/cast/actor'
...
const CastPage = () => {
  const mediaData = {
    ...
    cast:[
        {
            actor_name:'چاتای اولسون',
            actor_img:'/images/chatay-thumb.jpg',
            actor_link:'/actor/chatay',
            role_name:'دوان',
        },
        {
            actor_name:'شهلا ریاحی',
            actor_img:'/images/chatay-thumb.jpg',
            actor_link:'/actor/chatay',
            role_name:'شهلا',
        },
        {
            actor_name:'غلام حیدری',
            actor_img:'/images/chatay-thumb.jpg',
            actor_link:'/actor/chatay',
            role_name:'غلام',
        },
        ...
        <div className="xl:container mx-auto">
          <div className="grid grid-cols-8 gap-8">
            ...
            <div className="col-span-8 lg:col-span-6 mt-5">
              ...
              {mediaData.cast.map((da, i) => (
                <ActorCard data={da } key={i} />
               ))}
